 ...
 *
 * All 4 corners use same gradient style (matrix transform)
 * Top/bottom bands on end caps have same gradient as side bands
 */
...
(function () {
  ...
  class SVGScreenConfigurator {
    ...
    renderSVG(widthMM, heightMM, colors, fabricType) {
      ...
      this.svg.innerHTML = `
        <defs>
          <!-- ALL 4 CORNERS: Same gradient style with matrix transform -->
          
          <!-- Top-left: gradient radiates from inner corner (bottom-right) -->
          ...
          <!-- Top-right: gradient radiates from inner corner (bottom-left) -->
          ...
          <!-- Bottom-left: SAME as top-left but for bottom position -->
          ...
          <!-- Bottom-right: SAME as top-right but for bottom position -->
          ...
          <!-- End cap side gradients (horizontal) - used for middle AND top/bottom on end caps -->
        ...
        <g transform="translate(${PAD}, ${PAD})">
          ...
          <g class="cassette">
            ...
            <!-- ═══ LEFT END ═══ -->
            <g class="left-end">
              <!-- Top band (same gradient as side) -->
              <rect x="0" y="0" width="${W}" height="${H}" fill="url(#leftSide)" />
              ...
              <!-- Bottom band (same gradient as side) -->
              <rect x="0" y="${H + F.MIDDLE_BAND}" width="${W}" height="${F.BOTTOM_BAND}" fill="url(#leftSide)" />
            ...
            <g class="right-end" transform="translate(${totalW - W}, 0)">
              <!-- Top band (same gradient as side) -->
              <rect x="0" y="0" width="${W}" height="${H}" fill="url(#rightSide)" />
              ...
              <!-- Bottom band (same gradient as side) -->
              <rect x="0" y="${H + F.MIDDLE_BAND}" width="${W}" height="${F.BOTTOM_BAND}" fill="url(#rightSide)" />
